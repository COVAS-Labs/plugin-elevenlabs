...
$artifacts = "cn-plugin-elevenlabs.py", "requirements.txt", "manifest.json", "__init__.py"
...
DestinationPath = "dist\cn-plugin-elevenlabsPlugin.zip" # Change the name of the plugin
}
